...
buster.testCase("testAdvanced", {
    setUp: function() {
        ...
        var b2 = new HSM.CompositeState("b2", new HSM.StateMachine([b21, b22]));

        var b = new HSM.CompositeState("b", new HSM.StateMachine([b1, b2]));
        ...
        var c = new HSM.ParallelState("c", new HSM.StateMachine([c11, c12]),
