...
buster.testCase("testCompositeStates", {
    setUp: function() {
	    var _ = this;
		// Sub State Machine
		...
		_.onState = new HSM.CompositeState("OnState", _.volumeStateMachine);
	...
	"testInheritance" : function() {
		...
		assert(_.onState instanceof HSM.CompositeState);
	},
	"testSubMachine" : function() {
		...
		assert.equals("OnState", _.sm.state().subMachine().id());
